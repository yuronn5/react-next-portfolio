                ...
                <div className="space-y-12">
                    ...
                    <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="glass p-8 rounded-2xl space-y-8">
                        <div className="space-y-2">
                            ...
                            <a href="tel: +111111111" className="text-2xl font-semibold hover:text-purple-400 transition duration-300 flex items-center gap-2">+111111111
                                <span className="text-gray-500">↗️</span>
                            </a>
                        </div>
                        <div className="space-y-2">
                            <p className="text-lg text-gray-300">Email</p>
                            <a href="mailto: lG0eE@example.com" className="text-3xl lg:text-4xl font-semibold hover:text-purple-400 transition duration-300 flex items-center gap-2">lG0eE@example.com
                                <span className="text-gray-500">↗️</span>
                            </a>
                        </div>
                        <div className="space-y-2">
